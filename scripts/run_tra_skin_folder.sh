...
output=/data/yh/FACE_2024/facexlib/result/val_512_skin_tra
mkdir -p $output
...
python ../inference/face_process.py --img_path $input/$file --save_path $output/${file%.*}_2.jpg --half --output_txt --target_size 512 --max_size 1024 --task traditional_skin
done
